...
public class QKART_Tests {
    ...
    public void TestCase03(String username, String password) {
        ...
        assertNotEquals(searchResults.size(), 0,
    ...
    public void TestCase05(String username, String password, String product1, String product2, String address)
        ...
        // Check if placing order redirected to the Thank page
    ...
    @Test(enabled = true, description = "Verify that the contents of the cart can be edited", priority = 6, groups = {"Regression_Test"})
    @Parameters({"username", "password", "product3", "product4", "address"})
    public void TestCase06(String username, String password, String product1, String product2, String address) throws InterruptedException {
        Boolean status;
        ...
        try {
            ...
            assertFalse(false, "Error while placing order in: " + e.getMessage());
        }
