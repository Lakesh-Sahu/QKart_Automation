...
public class Screenshot {
    ...
    public static WebDriver getDriverForScreenshot(String className) {
        return switch (className) {
            case "qkart.testcases.TestsA" -> TestsA.driver;
            case "qkart.testcases.TestsB" -> TestsB.driver;
            case "qkart.testcases.TestsC" -> TestsC.driver;
            case "qkart.testcases.TestsD" -> TestsD.driver;
            case "qkart.testcases.TestsE" -> TestsE.driver;
            default -> null;
        };
    }
}
