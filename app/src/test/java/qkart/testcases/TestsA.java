...
public class TestsA extends Base {
    ...
    public void TestCase02(String username, String password) {
        ...
        assertTrue(oc.registration.navigateToRegisterPage(), "User is unable to navigate to register page");
        assertTrue(oc.registration.verifyOnRegisterPage(), "User is not on registration page");
        // If status is true, then registration succeeded, else registration has
        // failed. In this case registration failure means Success
        assertFalse(oc.registration.registerUser(usernameDynamic, password, password), "Test Case 02: Verify re-registering an already registered user fails : FAIL");
    }
    ...
    public void TestCase03() {
        ...
        assertTrue(oc.homePage.searchForProduct(productName), "User is unable to search for " + productName + " product");
        ...
        assertTrue(oc.homePage.isNoResultFound(), "\"No product found\" message is not displayed for the invalid product name " + productName);
    }
    ...
    public void TestCase05(String username, String password, String productName1, String productName2, String address) {
        ...
        assertTrue(oc.homePage.searchForProduct(productName1), "User is unable to search for " + productName1);
        assertTrue(oc.homePage.addProductToCart(productName1), "User is unable to add product in cart for " + productName1);
        assertTrue(oc.homePage.searchForProduct(productName2), "User is unable to search for " + productName2);
        assertTrue(oc.homePage.addProductToCart(productName2), "User is unable to add product in cart for " + productName2);
    ...
    public void TestCase06(String username, String password, String productName3, String productName4, String address) {
        ...
        assertTrue(oc.homePage.searchForProduct(productName4), "User is unable to search for " + productName4);
        assertTrue(oc.homePage.addProductToCart(productName4), "User is unable to add product in cart for " + productName4);

        // update productName3 quantity to 2
        assertTrue(oc.homePage.changeProductQuantityInCart(productName3, 5), "User is unable to change the product quantity for " + productName3);

        // update table lamp quantity to 0
        assertTrue(oc.homePage.changeProductQuantityInCart(productName4, 0), "User is unable to change the product quantity for " + productName4);

        // update watch quantity again to 1
        assertTrue(oc.homePage.changeProductQuantityInCart(productName3, 1), "User is unable to change the product quantity for " + productName3);
